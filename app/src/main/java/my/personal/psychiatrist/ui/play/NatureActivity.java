...
public class NatureActivity extends AppCompatActivity implements NatureAdapter.OnItemClickListener{
    ...
    private static final String TAG = "Nature";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.nature_recycler);
        setUpRecyclerView();
